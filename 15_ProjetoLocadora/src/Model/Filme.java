...
public class Filme {
	...
	private String data_lancamento_filme;
	...
	public String getData_lancamento_filme() {
		return data_lancamento_filme;
	}
	public void setData_lancamento_filme(String data_lancamento_filme) {
		this.data_lancamento_filme = data_lancamento_filme;
	}
